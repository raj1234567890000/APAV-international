...
const product = [
  ...
  },
  {
    ...
    price: "₹ 33,040 / Piece",
    details: ["Type: Hot and Cold", "Phase: Single", "Number of Taps: 2"],
    img: "https://5.imimg.com/data5/SELLER/Default/2022/12/SR/RB/SG/1758521/customized-ro-plant-250x250.webp",
  },
  {
...
const Home = () => {
  return (
    <>
      ...
      <section className="w-full bg-gradient-to-r from-blue-50 to-teal-50 py-12">
        {" "}
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl md:text-3xl font-semibold text-teal-700 mt-2">
              {" "}
              APAV International Pvt Ltd{" "}
            </h1>{" "}
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              {" "}
              We have established ourselves as a leading manufacturer of a wide
              range of Water Purifier Systems and Coolers. These offered
              products are highly appreciated for their high quality and super
              performance.{" "}
            </p>{" "}
            <p className="mt-4 text-lg font-semibold text-gray-800 flex justify-center items-center gap-2">
              {" "}
              <Phone size={18} className="text-teal-600" />{" "}
              76689900092,76689900092{" "}
            </p>{" "}
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
              ...
              <div className="space-y-3">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">Total Employees:</span> Upto
                  10 People{" "}
                </p>{" "}
                <p className="flex items-center gap-2">
                  {" "}
                  <Calendar size={18} className="text-teal-600" />{" "}
                  <span className="font-semibold">GST Registration Date:</span>{" "}
                  31-07-2017{" "}
                </p>{" "}
                <p className="flex items-center gap-2">
                  {" "}
                  <FileText size={18} className="text-teal-600" />{" "}
                  <span className="font-semibold">Legal Status of Firm:</span>{" "}
                  Limited Company{" "}
                </p>{" "}
              </div>{" "}
              <div className="space-y-3">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">Annual Turnover:</span> 1.5 -
                  5 Cr{" "}
                </p>{" "}
                <p className="flex items-center gap-2">
                  {" "}
                ...
                <p className="flex items-center gap-2">
                  ...
                  <span className="font-semibold">GST No.:</span>4525253265223{" "}
                </p>{" "}
                <p className="flex items-center gap-2">
                  {" "}
                  <FileText size={18} className="text-teal-600" />{" "}
                  <span className="font-semibold">CIN No.:</span>{" "}
                  U32109DL2004PTC125842{" "}
                </p>{" "}
                <p className="flex items-center gap-2 text-green-700 font-semibold">
                  {" "}
                  <ShieldCheck size={18} className="text-green-600" /> Trustseal
                  Verified{" "}
                </p>{" "}
              </div>{" "}
            </div>{" "}
